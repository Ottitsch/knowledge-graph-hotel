...
| **LO8** | Apply a system to evolve a Knowledge Graph | `src/evolve/version_snapshot.py` · `src/evolve/diff_snapshots.py` · `data/snapshots/` (7 snapshots) · `reports/evolution/evolution_report.md` (current diff shows `rule_fact_delta = +256` after the `professional_operator` threshold was lowered from 4 to 3) |
