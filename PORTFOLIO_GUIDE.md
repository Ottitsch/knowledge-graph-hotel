...
3. **Reasoning evidence:** `reports/rule_inference_report.md` and `graph/inferred_facts.ttl`
4. **ML evidence:** `reports/embedding_report.md` and `reports/embedding_examples.md`
5. **Reflection:** the four `reports/*_comparison.md`, `reports/*_reasoning.md`, `reports/*_interaction.md`, `reports/financial_kg_comparison.md`
