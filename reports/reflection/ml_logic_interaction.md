...
|---|---|---|
| Symbolic / logic | `ontology/accommodation_operator.owl`, `accommodation_operator_shapes.ttl`, `src/rules.yml`, `src/construct/materialize_rules.py` | Class hierarchy, integrity constraints, forward-chaining inference |
| Statistical / ML | `src/learn/train_embeddings.py` (TransE), `src/learn/score_candidates.py` | Vector representation of every entity and relation; similarity ranking |
